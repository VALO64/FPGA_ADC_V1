...
HD_PWD='D:/Oscar/TEC/Octavo_Semestre/FPGA/Unidad 2/EJE_TEST/EJE_TEST.runs/design_1_Cuantificador_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Cuantificador_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Cuantificador_0_0.tcl
